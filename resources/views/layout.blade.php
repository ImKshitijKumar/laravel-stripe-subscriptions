            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="stripe_publish_key" class="form-control" placeholder="Enter Stripe Publishable key...">
                    </div>
                    <div class="form-group">
                        <label>Stripe Secret Key</label>
                        <input type="text" name="stripe_secret_key" class="form-control" placeholder="Enter Stripe Secret key...">
                    </div>
                </div>
